...
app.post("/jokes", (req, res)=> {
  ...
  jokes.push(newJoke);
  console.log(jokes.slice(-1)); // the last joke 
  res.json(newJoke);
});
//5. PUT a joke
...
app.patch("/jokes/:id", (req, res) => {
  ...
  const replacementJoke = {
    id: id,
    jokeText: req.body.text || existingJoke.jokeText, //if it is provided then it updates it, else it keeps the existing one
...
app.delete("/all", (req, res) => {
  ...
  else
  {
    res
      .status(404)
      .json({ error: 'You cannot do this action!'});
  }
});
